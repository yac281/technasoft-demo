...
@section('title', 'Nuovo point')
@section('page-title', 'Nuovo point')
    ...
    <section id="page-content" class="col px-0 pb-5 mb-5 pb-lg-4 mb-lg-0">
        ...
        <div class="px-3">
            <section class="card no-after shadow-y0 bg-white rounded">
                ...
                <div class="card-body">
                    {!! Form::open(['route'=>'points.store', 'method'=>'POST', 'class'=>'', 'id'=>'create-item']) !!}
                    <div class="form-row">
                        <div class="form-group form-boxed col-md-6">
                            ...
                            {!! Form::text('point_name', old('point_name'), ['class' => 'form-control form-control-sm ']) !!}
                        </div>
                    </div>
