...
@section('title', 'Modifica servizio: '.$service->service_name)
    ...
    <section id="page-content" class="col px-0 pb-5 mb-5 pb-lg-4 mb-lg-0">
        ...
        <div class="px-3">
            <section class="card no-after shadow-y0 bg-white rounded">
                ...
                <div class="card-body">
                    {!! Form::open(['route'=>['services.update', $service->id], 'method'=>'POST', 'class'=>'', 'id'=>'edit-item']) !!}
                    <div class="form-row">
                        <div class="form-group form-boxed col-md-6">
                            ...
                            {!! Form::text('service_name', old('service_name',$service->service_name), ['class' => 'form-control form-control-sm ']) !!}
                        </div>
                        <div class="form-group form-boxed col-md-6">
                            {!! Form::label('service_desc', 'Descrizione '.'<b class="text-danger">* <span class="sr-only">'.__('forms.required').'</span></b>','', false) !!}
                            {!! Form::text('service_desc', old('service_desc',$service->service_desc), ['class' => 'form-control form-control-sm ']) !!}
                        </div>
                    </div>
